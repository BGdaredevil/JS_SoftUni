...
const teamCurrentMembersTemplate = (team, visitorId) => html` <div class="pad-large">
  <h3>Members</h3>
  <ul class="tm-members">
...
const teamMemberRequestsTemplate = (team) => html` <div class="pad-large">
...
const singleRequestTemplate = (request) => html` <li>
...
const teamHomeTemplate = (team, visitorId) => html`<section id="team-home">
